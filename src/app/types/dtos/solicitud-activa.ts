...
export class SolicitudActiva {
    ...
    static fromJson(json: any): SolicitudActiva {
        let result = new SolicitudActiva();
        for (let key in json) {
    ...
    public clone(): SolicitudActiva {
        return SolicitudActiva.fromJson(this.toJson());
    }
}
